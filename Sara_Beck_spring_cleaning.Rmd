...
```{r}
# 
# plot_1 <- ggplot(weekavg,aes(x=weekly,y=weekly_magnitude)) + geom_line() +
#   easy_rotate_x_labels(angle=45) + scale_y_reverse() +
#   labs(title="Weekly Mean Magnitude")
# 
# plot_2 <- ggplot(dailyavg,aes(x=Julian,y=daily_magnitude)) + geom_line() +
